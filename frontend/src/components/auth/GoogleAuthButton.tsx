...
export default function GoogleAuthButton({
  ...
  return (
    <button
      ...
      onClick={onClick}
      disabled={disabled}
      className="flex w-full items-center justify-center gap-3 rounded-md border border-[var(--line)] bg-[var(--bg-elevated)] px-4 py-2.5 text-sm font-semibold transition hover:bg-[var(--accent-soft)] disabled:cursor-not-allowed disabled:opacity-60"
    >
